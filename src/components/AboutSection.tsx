        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center">
            <div className="relative group">
              ...
              <div className="relative w-80 h-80 rounded-full overflow-hidden shadow-2xl m-2 group-hover:scale-105 transition-transform duration-300">
                <img 
              ...
              {/* Availability badge */}
              <div className="absolute -bottom-2 -right-2 w-28 h-28 bg-primary rounded-full flex items-center justify-center shadow-lg animate-pulse">
                <span className="text-white font-bold text-sm text-center">Available<br/>for Work</span>
              </div>
              
              {/* Floating particles */}
              <div className="absolute top-4 right-4 w-3 h-3 bg-blue-400 rounded-full animate-bounce" style={{ animationDelay: '0.5s' }}></div>
              <div className="absolute bottom-16 left-4 w-2 h-2 bg-purple-400 rounded-full animate-bounce" style={{ animationDelay: '1s' }}></div>
              <div className="absolute top-16 left-8 w-2 h-2 bg-pink-400 rounded-full animate-bounce" style={{ animationDelay: '1.5s' }}></div>
            </div>
          </div>
        </div>
      </div>
